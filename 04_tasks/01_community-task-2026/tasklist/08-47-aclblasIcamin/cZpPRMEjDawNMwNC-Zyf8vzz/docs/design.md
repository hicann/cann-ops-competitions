...
| 参与者账号 | `cZpPRMEjDawNMwNC-Zyf8vzz`（GitCode：`Eason_Cat`） |
| 目标硬件 | Ascend 950PR（arch35 / DAV_3510） |
| CANN 版本 | CANN 9.1.0 |
| 交付代码仓 | [Eason_Cat/ops-blas](https://gitcode.com/Eason_Cat/ops-blas)（私仓）分支 `feature/icamin-arch35-950`；合入目标 [cann/ops-blas](https://gitcode.com/cann/ops-blas) `master` |
| 设计提交路径 | `04_tasks/01_community-task-2026/tasklist/08-47-aclblasIcamin/cZpPRMEjDawNMwNC-Zyf8vzz/docs/design.md` |
...
| 7 | 代码私仓 | https://gitcode.com/Eason_Cat/ops-blas `feature/icamin-arch35-950`，邀请 Ascend-CANN |
