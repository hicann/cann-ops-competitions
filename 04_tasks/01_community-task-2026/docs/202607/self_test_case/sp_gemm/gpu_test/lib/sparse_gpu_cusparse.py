...
from sparse_common import require_cuda
from sparse_common import scatter_csr_to_dense
...
def cusparse_sddmm(
    ...
    try:
        ...
        check_cusparse(lib.cusparseCreateCsr(
            ...
            _cusparse_index_32i(), _cusparse_index_32i(), CUSPARSE_INDEX_BASE_ZERO, c_cuda_type), "CreateCsr(C)")
...
def cusparse_spsm(
    ...
    try:
        ...
        check_cusparse(lib.cusparseCreateCsr(
            ...
            _cusparse_index_32i(), _cusparse_index_32i(), CUSPARSE_INDEX_BASE_ZERO, CUDA_R_32F), "CreateCsr(A)")
