...
请根据给出的[自测用例和测试指导](./self_test_case/bloom_filter/)完成自测，并输出自测报告。
...
| Key  | Hash  |  Word | BlockBits  | PatternBits  |  HorizontalLayout |  VerticalLayout | FilterSizeMB  | Total Time（ms） |
| ------------ | ------------ | ------------ | ------------ | ------------ | ------------ | ------------ | ------------ | ------------ |
| I32  | XXHash_64  | U32  | 256  | 8  |  8 |  1 | 32  | 0.96 |
| I32  | XXHash_64  | U32  | 256  | 8  |  8 |  1 | 256  | 9.19 |
| I32  | XXHash_64  | U32  | 256  | 8  |  8 |  1 | 2048  | 73.57 |
| I64  | XXHash_64  | U32  | 256  | 8  |  8 |  1 | 32  | 0.96 |
| I64  | XXHash_64  | U32  | 256  | 8  |  8 |  1 | 256  | 9.44 |
| I64  | XXHash_64  | U32  | 256  | 8  |  8 |  1 | 2048  | 73.1 |
...
| Key  | Hash  |  Word | BlockBits  | PatternBits  |  HorizontalLayout |  VerticalLayout | FilterSizeMB  | Total Time（ms） |
| ------------ | ------------ | ------------ | ------------ | ------------ | ------------ | ------------ | ------------ | ------------ |
| I32  | XXHash_64  | U32  | 256  | 8  |  8 |  1 | 32  | 0.09 |
| I32  | XXHash_64  | U32  | 256  | 8  |  8 |  1 | 256  | 0.49 |
| I32  | XXHash_64  | U32  | 256  | 8  |  8 |  1 | 2048  | 3.73 |
| I64  | XXHash_64  | U32  | 256  | 8  |  8 |  1 | 32  | 0.09 |
| I64  | XXHash_64  | U32  | 256  | 8  |  8 |  1 | 256  | 0.49 |
| I64  | XXHash_64  | U32  | 256  | 8  |  8 |  1 | 2048  | 3.72 |

**Add**

| Key  | Hash  |  Word | BlockBits  | PatternBits  |  HorizontalLayout |  VerticalLayout | NumInput |FilterSizeMB  | Total Time（ms） |
| ------------ | ------------ | ------------ | ------------ | ------------ | ------------ | ------------ | ------------ | ------------ | ------------ |
| I32  | XXHash_64  | U32  | 256  | 8  |  8 |  1 | 80000000 | 32  | 14.77 |
| I32  | XXHash_64  | U32  | 256  | 8  |  8 |  1 | 80000000 |256  | 18.82 |
| I32  | XXHash_64  | U32  | 256  | 8  |  8 |  1 | 80000000 |2048  | 20.24 |
| I64  | XXHash_64  | U32  | 256  | 8  |  8 |  1 | 80000000 |32  | 14.82 |
| I64  | XXHash_64  | U32  | 256  | 8  |  8 |  1 | 80000000 |256  | 18.83 |
| I64  | XXHash_64  | U32  | 256  | 8  |  8 |  1 | 80000000 |2048  | 20.25 |

**Contains**

| Key  | Hash  |  Word | BlockBits  | PatternBits  |  HorizontalLayout |  VerticalLayout | NumInput |FilterSizeMB  | Total Time（ms） |
| ------------ | ------------ | ------------ | ------------ | ------------ | ------------ | ------------ | ------------ | ------------ | ------------ |
| I32  | XXHash_64  | U32  | 256  | 8  |  8 |  1 | 80000000 | 32  | 8.52 |
| I32  | XXHash_64  | U32  | 256  | 8  |  8 |  1 | 80000000 |256  | 19.19 |
| I32  | XXHash_64  | U32  | 256  | 8  |  8 |  1 | 80000000 |2048  | 20.62 |
| I64  | XXHash_64  | U32  | 256  | 8  |  8 |  1 | 80000000 |32  | 8.56 |
| I64  | XXHash_64  | U32  | 256  | 8  |  8 |  1 | 80000000 |256  | 19.2 |
| I64  | XXHash_64  | U32  | 256  | 8  |  8 |  1 | 80000000 |2048  | 20.63 |
...
| I32  | XXHash_64  | U32  | 256  | 8  |  8 |  1 | 32  | 0.09 |
| I32  | XXHash_64  | U32  | 256  | 8  |  8 |  1 | 256  | 0.49 |
| I32  | XXHash_64  | U32  | 256  | 8  |  8 |  1 | 2048  | 3.71 |
| I64  | XXHash_64  | U32  | 256  | 8  |  8 |  1 | 32  | 0.09 |
| I64  | XXHash_64  | U32  | 256  | 8  |  8 |  1 | 256  | 0.49 |
| I64  | XXHash_64  | U32  | 256  | 8  |  8 |  1 | 2048  | 3.71 |

**Intersect**

| Key  | Hash  |  Word | BlockBits  | PatternBits  |  HorizontalLayout |  VerticalLayout | NumInput |FilterSizeMB  | Total Time（ms） |
| ------------ | ------------ | ------------ | ------------ | ------------ | ------------ | ------------ | ------------ | ------------ |------------ |
| I32  | XXHash_64  | U32  | 256  | 8  |  1 |  8 | 80000000 |32  | 35.4 |
| I32  | XXHash_64  | U32  | 256  | 8  |  1 |  8 | 80000000 |256  | 149.74 |
| I32  | XXHash_64  | U32  | 256  | 8  |  1 |  8 | 80000000 |2048  | 175.15 |
| I64  | XXHash_64  | U32  | 256  | 8  |  1 |  8 | 80000000 |32  | 36.99 |
| I64  | XXHash_64  | U32  | 256  | 8  |  1 |  8 | 80000000 |256  | 149.72 |
| I64  | XXHash_64  | U32  | 256  | 8  |  1 |  8 | 80000000 |2048  | 178.2 |

**Merge**

| Key  | Hash  |  Word | BlockBits  | PatternBits  |  HorizontalLayout |  VerticalLayout | NumInput |FilterSizeMB  | Total Time（ms） |
| ------------ | ------------ | ------------ | ------------ | ------------ | ------------ | ------------ | ------------ | ------------ |------------ |
| I32  | XXHash_64  | U32  | 256  | 8  |  1 |  8 | 80000000 |32  | 35.39 |
| I32  | XXHash_64  | U32  | 256  | 8  |  1 |  8 | 80000000 |256  | 149.73 |
| I32  | XXHash_64  | U32  | 256  | 8  |  1 |  8 | 80000000 |2048  | 175.07 |
| I64  | XXHash_64  | U32  | 256  | 8  |  1 |  8 | 80000000 |32  | 34.76 |
| I64  | XXHash_64  | U32  | 256  | 8  |  1 |  8 | 80000000 |256  | 149.73 |
| I64  | XXHash_64  | U32  | 256  | 8  |  1 |  8 | 80000000 |2048  | 175.03 |
