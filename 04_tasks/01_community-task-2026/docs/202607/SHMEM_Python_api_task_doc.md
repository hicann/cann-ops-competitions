...
请根据给出的[自测用例和测试指导](./self_test_case/shmem_python/)完成自测，并输出自测报告。
...
3. **代码交付**：个人代码仓链接、代码仓路径、分支、相关目录。README 文档内容完整、规范，能指导环境准备、构建、安装与测试。需要在个人仓邀请账号`Ascend-CANN`作为开发者，如下所示：
