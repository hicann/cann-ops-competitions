# CANN训练营2026暑期季 – 西北工业大学专场-NllLossGrad算子开发任务书
...
参考昇腾版本内置aclnnNLLLossBackward算子的 TBE 实现，在昇腾 NPU 上基于 Ascend C 编程语言实现功能一致的算子, 完成算子设计、开发、测试全流程工作，验收通过后将算子提交至昇腾算子开源仓。
...
验收通过后，在昇腾算子开源仓提交 PR 申请，申请将开发完成的算子合入（https://gitcode.com/cann/ops-nn/tree/master/experimental/loss）。
