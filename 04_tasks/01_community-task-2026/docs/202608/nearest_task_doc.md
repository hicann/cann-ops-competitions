...
给 Y 里每个点找 X 里最近的点。数据：随机两堆坐标。

| shape (X × 维度, Y) | float32 | float16 |
|-------|---------|---------|
| N=1K M=1K F=3 | 0.117ms | 0.117ms |
| N=4K M=4K F=3 | 0.231ms | 0.256ms |
| N=16K M=16K F=3 | 1.388ms | 1.624ms |
| N=32K M=32K F=3 | 4.464ms | 5.793ms |
| N=8K M=8K F=64 | 30.156ms | 30.152ms |
