...
按网格边长把点归到格子里。数据：随机 D 维坐标。

| shape (点数 × 维度, 格子边长) | float32 | float16 |
|-------|---------|---------|
| N=8M D=3 s=0.005 | 0.177ms | 0.195ms |
| N=16M D=3 s=0.002 | 0.349ms | 0.384ms |
| N=4M D=64 s=0.010 | 2.089ms | 2.111ms |
| N=8M D=32 s=0.005 | 2.121ms | 1.230ms |
| N=32M D=3 s=0.001 | 0.691ms | 0.762ms |
