...
每次挑离已选点最远的点，直到凑够比例。数据：随机 3D 坐标。

| shape (点数, 采样比例) | float32 | float16 |
|-------|---------|---------|
| N=1K r=0.50 | 1.378ms | 1.605ms |
| N=4K r=0.50 | 10.439ms | 12.596ms |
| N=16K r=0.25 | 137.367ms | 113.501ms |
| N=32K r=0.25 | 538.867ms | 565.284ms |
