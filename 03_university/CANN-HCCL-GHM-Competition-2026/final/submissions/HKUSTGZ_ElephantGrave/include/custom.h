...
constexpr uint32_t WRITE_REDUCE_16_LOCAL_A_MODE = 0xffffffb0U;
constexpr uint32_t WRITE_REDUCE_16_CROSS_B_MODE = 0xffffffb1U;
constexpr uint32_t WRITE_REDUCE_16_LOCAL_B_MODE = 0xffffffb2U;
constexpr uint32_t WRITE_REDUCE_16_CROSS_A_MODE = 0xffffffb3U;
constexpr uint32_t WRITE_REDUCE_12_LOCAL_A_MODE = 0xffffffb4U;
constexpr uint32_t WRITE_REDUCE_12_CROSS_B_MODE = 0xffffffb5U;
constexpr uint32_t WRITE_REDUCE_12_LOCAL_B_MODE = 0xffffffb6U;
constexpr uint32_t WRITE_REDUCE_12_CROSS_A_MODE = 0xffffffb7U;
...
constexpr uint64_t COMM_ID_CACHE_MAGIC = 0x5631325443494431ULL; // "V12TCID1"
static_assert(sizeof(std::array<char, COMM_INDENTIFIER_MAX_LENGTH>) == COMM_INDENTIFIER_MAX_LENGTH,
    "cached communicator id must have a padding-free serialized tail");
...
struct AlgResourceCtx {
    ...
    uint64_t commIdCacheMagic{COMM_ID_CACHE_MAGIC};
    ...
    std::vector<char> Serialize()
    {
        ...
        binaryStream << commIdCacheMagic;
        binaryStream << cachedCommId;
