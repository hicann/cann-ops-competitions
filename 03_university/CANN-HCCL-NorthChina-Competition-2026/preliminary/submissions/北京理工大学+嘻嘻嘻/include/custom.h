...
struct AlgResourceCtx {
    ...
    uint32_t interPeerRank = INVALID_VALUE_RANKID; ///< 分层 AllGather 的跨 Server 镜像 rank
    uint32_t intraGroupStart = INVALID_VALUE_RANKID; ///< RankGraph 推导的本 Server rank 组起点
