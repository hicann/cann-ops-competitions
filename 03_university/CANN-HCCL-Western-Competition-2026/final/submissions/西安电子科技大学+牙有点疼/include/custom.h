...
// Arguments that stay constant for all launches on one communicator.
struct AllReduceKernelArg : CcuKernelArgBase {
    uint64_t rankSize = 0;
    ...
    uint32_t scratchSlotBase = 0;
    uint32_t partialSlot[2] = {};
    bool includeLocal = false;
    bool combineOnly = false;
    bool directBroadcast = false;
