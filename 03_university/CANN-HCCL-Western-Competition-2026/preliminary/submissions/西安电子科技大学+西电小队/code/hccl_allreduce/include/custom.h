...
struct AlgResourceCtx {
    ...
    std::vector<uint32_t> localRanks;          ///< Layer-0 ranks in deterministic order
    std::vector<uint32_t> globalRanks;         ///< All 16 ranks in deterministic order
    uint32_t interRank = INVALID_VALUE_RANKID; ///< Corresponding rank in the other server
