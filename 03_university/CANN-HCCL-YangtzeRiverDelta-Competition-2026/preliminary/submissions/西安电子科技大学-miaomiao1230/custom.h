...
constexpr uint32_t BROADCAST_AICPU_THREAD_NUM = 16;
constexpr uint32_t BROADCAST_AICPU_NOTIFY_NUM_PER_THREAD = 16;
constexpr uint64_t BROADCAST_SCATTER_ALLGATHER_THRESHOLD = 1ULL * 1024ULL * 1024ULL;
...
struct ChannelInfo {
    ...
    uint32_t netLayer = INVALID_VALUE_RANKID; ///< FillChannelDesc实际选中的网络层
};
