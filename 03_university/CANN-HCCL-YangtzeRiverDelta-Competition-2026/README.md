...
* 🎯 **参赛对象要求**：面向长三角地域学校内同学（通信类、计算机类、电子信息类、数学类等专业）。
...
### 4. 📝 Issue与PR提交
#### 4.1 Issue
根据问题情况选择合适的类别提交issue，标题前缀需要加上【2026 HCCL通信库创新大赛-长三角赛区】【团队名称】; 

#### 4.2 PR
在pr标题前缀需要加上【2026 HCCL通信库创新大赛-长三角赛区】【团队名称】; 提交pr后需关联对应issue; 
