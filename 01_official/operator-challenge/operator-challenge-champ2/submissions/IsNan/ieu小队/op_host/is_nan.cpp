...
// tile granularity in elements: a multiple of 256 simultaneously satisfies
//   - Compare 256B count alignment (half:128 / float:64 elems)
//   - int8 output 32B alignment (32 elems)
const uint32_t TILE_ALIGN     = 256;
const uint32_t MAX_TILE_HALF  = 21504;  // v6: BUFFER_NUM=2, 3-op compute (10.125B/elem)
const uint32_t MAX_TILE_FLOAT = 12288;
const uint32_t MAX_TILE_BF16  = 12288;
...
static ge::graphStatus TilingFunc(gert::TilingContext* context)
{
    ...
    uint64_t tilingKey = 0;                 // half by default
...
{
    // Output is always bool regardless of input float type.
