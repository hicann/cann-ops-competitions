...
int main()
{
    ...
    std::vector<int64_t> AShape = {1, 10016, 8, 64};
    ...
    CHECK_RET(ret == ACLNN_SUCCESS, LOG_PRINT("aclnnChunkScaledDotKktGetWorkspaceSize failed. ERROR: %d\n", ret); return ret);
    ...
    CHECK_RET(ret == ACLNN_SUCCESS, LOG_PRINT("aclnnChunkScaledDotKkt failed. ERROR: %d\n", ret); return ret);
